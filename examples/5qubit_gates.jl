...
function decompose_exact_random_target1()
    ...
    function target_gate()
        ...
        H_4 = QCOpt.get_full_sized_gate("H_4", num_qubits);
        H_5 = QCOpt.get_full_sized_gate("H_5", num_qubits);

        Y_3 = QCOpt.get_full_sized_gate("Y_3", num_qubits);

        T_1 = QCOpt.get_full_sized_gate("T_1", num_qubits);
        T_2 = QCOpt.get_full_sized_gate("T_2", num_qubits);
        ...
        return CNot_3_4 * CNot_2_3 * T_5 * CH_4_5 * CNot_2_3
